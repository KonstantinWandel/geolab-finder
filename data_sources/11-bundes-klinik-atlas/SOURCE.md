# Fachärztesuche - Weisse Liste

<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 12).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://www.weisse-liste.de/de/arzt/arztsuche/
- **Access:** web UI / search form only, on request / registration needed
- **Spatial levels:** Gemeinden und Verbandsgemeinden, Bezirke, Bezirksregionen / Ortsteile, PLZ
- **Temporal coverage:** 2021–2021
- **Update frequency:** laufend
- **Workbook note:** eingestellt

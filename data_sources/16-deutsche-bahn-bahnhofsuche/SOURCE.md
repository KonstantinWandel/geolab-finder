...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 17).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://www.bahnhof.de/bahnhof-de
- **Access:** web UI / search form only, on request / registration needed
- **Spatial levels:** Gemeinden und Verbandsgemeinden, Bezirke, Bezirksregionen / Ortsteile, Adressen / Koordinaten
- **Temporal coverage:** not stated
- **Update frequency:** n/a
- **Workbook note:** Copyright 2024, sonst keine Angabe

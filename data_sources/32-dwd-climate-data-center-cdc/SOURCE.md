...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 33).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://opendata.dwd.de/climate_environment/CDC/
- **Access:** direct file download, machine-readable API
...
- **Workbook note:** Stations- und Rasterdaten (1 km) zu Temperatur, Niederschlag, Sonnenschein, Hitze- und Frosttagen; offen ohne Anmeldung

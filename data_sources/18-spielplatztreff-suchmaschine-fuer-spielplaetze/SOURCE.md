# Spielplatztreff - Suchmaschine für Spielplätze

<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 19).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://www.spielplatztreff.de/
- **Access:** web UI / search form only, on request / registration needed
- **Spatial levels:** Bundesland, Gemeinden und Verbandsgemeinden, Bezirke, Bezirksregionen / Ortsteile, PLZ, Adressen / Koordinaten
- **Temporal coverage:** not stated
- **Update frequency:** n/a
- **Workbook note:** keine Angabe , vermutlich laufend
- **Topic groups:** Kinder und Jugend

## Topics marked in the workbook

- **Kinder und Jugend**: Distanz nächster Spielplatz, Bewertung nächster Spielplatz

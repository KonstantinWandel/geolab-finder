# Arztsuche - Bundesärztekammer

<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 13).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://www.bundesaerztekammer.de/service/arztsuche/
...
- **Workbook note:** abhängig vom Bundesland
- **Topic groups:** Gesundheit

## Topics marked in the workbook

- **Gesundheit**: Anzahl (Fach-)Ärzte im Umkreis, Distanz zum nächsten (Fach-)Arzt

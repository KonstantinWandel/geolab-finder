...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 16).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://geovdbn.deutschebahn.com/isr
- **Access:** interactive map viewer, on request / registration needed
- **Spatial levels:** Gemeinden und Verbandsgemeinden, Adressen / Koordinaten
- **Temporal coverage:** 2024–2025
- **Update frequency:** n/a
- **Workbook note:** Stand 2024, vermutlich jährlich
- **Topic groups:** Verkehr / Mobilität

## Topics marked in the workbook

- **Verkehr / Mobilität**: Distanz zum nächsten Flughafen/Bahnhof/Autobahnauffahrt

...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 24).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://rapidapi.com/Implisense/api/german-company-data
- **Access:** machine-readable API, on request / registration needed
- **Spatial levels:** not stated
- **Temporal coverage:** not stated
- **Update frequency:** laufend
- **Workbook note:** none
- **Topic groups:** Wirtschaft und Unternehmen

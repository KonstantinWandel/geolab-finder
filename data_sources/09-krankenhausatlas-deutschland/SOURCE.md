...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 10).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://krankenhausatlas.statistikportal.de/
- **Access:** interactive map viewer, on request / registration needed
- **Spatial levels:** Bundesland, Gemeinden und Verbandsgemeinden, PLZ
- **Temporal coverage:** 2016–2016
- **Update frequency:** n/a
- **Workbook note:** Stand 2016
- **Topic groups:** Gesundheit

## Topics marked in the workbook

- **Gesundheit**: Erreichbarkeit / Distanz zum nächsten Krankenhaus, Fachabteilungen Krankenhaus

...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 43).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://www.bka.de/DE/AktuelleInformationen/StatistikenLagebilder/PolizeilicheKriminalstatistik/pks_node.html
- **Access:** direct file download, web UI / search form only
- **Spatial levels:** Bundesland, Kreise & kreisfreie Städte, Gemeinden und Verbandsgemeinden, weitere räumliche Gliederungen
- **Temporal coverage:** 1971–2026
- **Update frequency:** jährlich
- **Workbook note:** Straftaten nach Delikt, Aufklärung, Tatverdächtige und Opfer; Zeitreihen sowie ausgewählte Straftaten für Kreise und Städte
- **Topic groups:** Nachhaltigkeit, Soziales

## Topics marked in the workbook

- **Nachhaltigkeit**: Straßenverkehr
- **Soziales**

...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 44).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://www.mobilitaet-in-deutschland.de/
- **Access:** direct file download, web UI / search form only, on request / registration needed
...
- **Update frequency:** unregelmäßig
- **Workbook note:** Bundesweite Haushaltsbefragung zum Verkehrsverhalten (2002, 2008, 2017, 2023) mit Regionalkennung; Scientific-Use-File über die Clearingstelle Verkehr, Ergebnisberichte und Regionaltabellen frei
- **Topic groups:** Arbeitsmarkt & Beschäftigung, Verkehr / Mobilität

## Topics marked in the workbook

- **Arbeitsmarkt & Beschäftigung**: Ein-/Auspendler
- **Verkehr / Mobilität**: PKW-Dichte, ÖPNV, tatsächliche Mobilität (Standortdaten)

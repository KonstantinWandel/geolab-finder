...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 29).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://www-genesis.destatis.de/genesis/online
- **Access:** direct file download, web UI / search form only, machine-readable API
- **Spatial levels:** Bundesland, Kreise & kreisfreie Städte
- **Temporal coverage:** 1949–2026
- **Update frequency:** laufend
- **Workbook note:** Bundesdatenbank der amtlichen Statistik; Tabellenkatalog über die REST-API abrufbar
- **Topic groups:** Arbeitsmarkt & Beschäftigung, Bauen / Wohnen, Bevölkerung, Bildung, Soziales, Wirtschaft und Unternehmen

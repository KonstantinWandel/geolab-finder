# Luftqualitätsdaten des Umweltbundesamtes

<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 42).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://www.umweltbundesamt.de/daten/luft/luftdaten
- **Access:** direct file download, web UI / search form only, machine-readable API, interactive map viewer
- **Spatial levels:** Bundesland, Kreise & kreisfreie Städte, Adressen / Koordinaten, weitere räumliche Gliederungen
- **Temporal coverage:** 1990–2026
- **Update frequency:** stündlich
- **Workbook note:** Messwerte von rund 500 Stationen (Feinstaub, Stickstoffdioxid, Ozon und weitere) mit Koordinaten und Stationstyp, offene JSON-Schnittstelle; dazu die Lärmkartierung nach Umgebungslärmrichtlinie
- **Topic groups:** Gesundheit, Nachhaltigkeit

...
<!-- Auto-generated stub from Geospatial_Data_Sources.xlsx (row 28).
     Everything below the "Manual notes" line is yours to edit; the generator will
     never overwrite this file once it exists. -->

- **Portal URL:** https://unfallatlas.statistikportal.de/
- **Access:** direct file download, interactive map viewer
- **Spatial levels:** Bundesland, Kreise & kreisfreie Städte, Gemeinden und Verbandsgemeinden, Adressen / Koordinaten
- **Temporal coverage:** 2016–2025
- **Update frequency:** jährlich
- **Workbook note:** Unfälle mit Personenschaden, georeferenziert (Einzelunfälle); Länder treten schrittweise bei
